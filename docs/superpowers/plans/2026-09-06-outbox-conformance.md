...
- [x] **Step 2: Run the tests to verify they fail for the missing API**
...
- [x] **Step 3: Implement the minimal typed suite scaffold**
...
- [x] **Step 4: Run the focused tests to verify the scaffold passes**
...
- [x] **Step 1: Write the failing scenario assertions**
...
- [x] **Step 2: Run the focused conformance test to verify the new scenarios fail**
...
- [x] **Step 3: Implement the scenario bodies**
...
- [x] **Step 4: Run the focused conformance test to verify green**
...
- [x] **Step 2: Run the focused conformance test to verify the new assertions fail**

Run `/Users/nitoba/.bun/bin/bun test tests/conformance.test.ts`.

Expected: the newly registered behavior assertions fail until their scenario bodies are implemented.

- [x] **Step 3: Implement the remaining scenarios and report tracking**
...
- [x] **Step 1: Add the failing boundary/documentation expectation**
...
- [x] **Step 2: Run the boundary test to verify RED, then rebuild for GREEN**
...
- [x] **Step 3: Add concise README usage**
...
- [x] **Step 4: Run focused package checks**
...
- [x] **Step 1: Run the complete proportional verification**
...
- [x] **Step 2: Request a read-only code review**
