...
6. Call APIs with the [HTTP client](/docs/http), including typed responses and
   streaming boundaries.
7. Adapt a Kysely database with the [Kysely integration](/docs/kysely).
8. Adapt a server-side Better Auth instance with [Better Auth](/docs/better-auth).
