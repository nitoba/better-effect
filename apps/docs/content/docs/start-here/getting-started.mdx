...
1. Learn how [Services](/docs/core/services) become typed dependency tokens.
2. Compose implementations with [Layers](/docs/core/layers).
3. Understand execution and shutdown in [Runtime](/docs/core/runtime).
4. Add ownership to connections and files with [Scope](/docs/core/scope) and
   [Resource](/docs/core/resource).
5. Integrate request handlers with [Hono](/docs/integrations/hono).
6. Call APIs with the [HTTP client](/docs/integrations/http), including typed responses and
   streaming boundaries.
7. Adapt a Kysely database with the [Kysely integration](/docs/integrations/kysely).
8. Adapt a server-side Better Auth instance with [Better Auth](/docs/integrations/better-auth).
