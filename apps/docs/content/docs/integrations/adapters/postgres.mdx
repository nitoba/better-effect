...
The payload codec is a Zod 4 schema passed through the Standard Schema bridge;
use [`better-effect-schema`](../schema) when the application also needs
schema-backed classes or normalized validation failures.
