...
The payload codec uses a Zod 4 schema through `Codec.standardSchema`; see
[`better-effect-schema`](../schema) when a schema-backed class or normalized
validation failure is useful.
