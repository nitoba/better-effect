...
Read the [MQ guide](/docs/mq) for the storage-neutral contracts, the
[adapter guides](/docs/integrations/adapters) for durable providers, and the
...
see [Layer-first migration](/docs/reference/migration).
