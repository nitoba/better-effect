...
[Defining Jobs](./defining-jobs) and observes it with `TestJobStore`; it does
...
production boundary. Keep the [trusted JSON escape hatch](./defining-jobs#trusted-json-escape-hatch)
