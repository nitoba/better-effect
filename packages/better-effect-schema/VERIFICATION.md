...
> Historical verification evidence for the predecessor package. The renamed
> `better-effect-schema` package is not release-ready until provider adapters are
> integrated; current command results belong in the issue/PR handoff.

**Package:** `better-effect-schema@0.1.0` (renamed from `better-effect-zod`)
**Date:** 2026-09-02
