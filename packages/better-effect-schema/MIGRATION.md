...
> Historical migration guide for the predecessor `better-effect-zod@0.1.0`
> package. The current workspace package is `better-effect-schema`; its release is
> blocked until provider adapters are integrated.
